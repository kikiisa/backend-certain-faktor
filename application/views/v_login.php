...
<head>
  ...
  <title>Login</title>
  <link link rel="icon" href="<?php echo base_url('stisla/img/logo.png')?>" type="image/x-icon">
  <!-- General CSS Files -->
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card ">
              <div class="card-header justify-content-center"><h3 class="text-primary">SPPK</h3></div>
              <div class="card-body">
                <?= $this->session->flashdata("alert") ?>
                <form method="POST" action="<?= site_url('Login/store') ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <input id="password" placeholder="Enter Password" type="password" class="form-control" name="password" tabindex="2" required>
                    <div class="invalid-feedback">
